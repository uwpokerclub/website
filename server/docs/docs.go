...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/EngagementStatsResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/MembershipStatsResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/semesters/{semesterId}/dashboard/spotlight": {
            "get": {
        ...
        "/semesters/{semesterId}/events/{eventId}/clock": {
            "get": {
        ...
        "/semesters/{semesterId}/events/{eventId}/clock/adjust": {
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/AdjustClockRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/semesters/{semesterId}/events/{eventId}/clock/level": {
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/SetClockLevelRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/semesters/{semesterId}/events/{eventId}/clock/pause": {
            "post": {
        ...
        "/semesters/{semesterId}/events/{eventId}/clock/resume": {
            "post": {
        ...
        "/semesters/{semesterId}/events/{eventId}/entries": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Search term to filter entries by participant name or student number (case-insensitive)",
                        "name": "search",
                        "in": "query"
                    }
                ],
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.CreateStructureRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/structures/{id}": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Partial structure data",
                        "name": "structure",
                        "in": "body",
                        "required": true,
                        "schema": {
    ...
    "definitions": {
        ...
        "ComparisonEngagementStats": {
            ...
            "properties": {
                ...
                "stats": {
                    "$ref": "#/definitions/EngagementStats"
                }
            }
        },
        ...
        "EngagementStatsResponse": {
            ...
            "properties": {
                "comparison": {
                    "$ref": "#/definitions/ComparisonEngagementStats"
                },
                "current": {
                    "$ref": "#/definitions/EngagementStats"
                }
        ...
        "MembershipStatsResponse": {
            ...
            "properties": {
                "comparison": {
                    "$ref": "#/definitions/ComparisonMembershipStats"
                },
                "current": {
                    "$ref": "#/definitions/MembershipStats"
                }
        ...
        "models.CreateStructureRequest": {
            ...
            "properties": {
                "blinds": {
                    ...
                    "minItems": 1,
                    "items": {
                        "$ref": "#/definitions/models.BlindJSON"
                    }
                },
                "name": {
                    "type": "string"

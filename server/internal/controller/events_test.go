...
func TestUpdateEvent(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			expectedStatus:       http.StatusBadRequest,
			expectError:          true,
			expectedErrorMessage: "Error parsing request body: Key: 'UpdateEventRequestV2.Name' Error:Field validation for 'Name' failed on the 'min' tag",
			setupEvent:           true,
			useEventID:           "1",
		},
		{
		...
		},
		{
			...
			expectedStatus:       http.StatusBadRequest,
			expectError:          true,
			expectedErrorMessage: "Error parsing request body: Key: 'UpdateEventRequestV2.Format' Error:Field validation for 'Format' failed on the 'min' tag",
			setupEvent:           true,
			useEventID:           "1",
		},
		{
		...
		},
		{
			...
			expectedStatus:       http.StatusBadRequest,
			expectError:          true,
			expectedErrorMessage: "Error parsing request body: parsing time \"invalid-date-format\" as \"2006-01-02T15:04:05Z07:00\": cannot parse \"invalid-date-format\" as \"2006\"",
			setupEvent:           true,
			useEventID:           "1",
		},
		{
		...
		},
		{
			...
			expectedStatus:       http.StatusBadRequest,
			expectError:          true,
			expectedErrorMessage: "Error parsing request body: Key: 'UpdateEventRequestV2.PointsMultiplier' Error:Field validation for 'PointsMultiplier' failed on the 'gte' tag",
			setupEvent:           true,
			useEventID:           "1",
		},
		{
			...
			expectedStatus:       http.StatusBadRequest,
			expectError:          true,
			expectedErrorMessage: "Error parsing request body: json: cannot unmarshal string into Go struct field UpdateEventRequestV2.pointsMultiplier of type float32",
			setupEvent:           true,
			useEventID:           "1",
		},
	}

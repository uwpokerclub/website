...
func TestListMemberships(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			userRole:       authorization.ROLE_BOT.ToString(),
			semesterID:     testutils.TEST_SEMESTERS[0].ID.String(),
			queryParams:    "?name=" + url.QueryEscape("John Doe"),
			expectedStatus: http.StatusOK,
			expectError:    false,
			minResults:     1,
			expectedTotal:  1,
		},
		{
			...
			userRole:       authorization.ROLE_BOT.ToString(),
			semesterID:     testutils.TEST_SEMESTERS[0].ID.String(),
			queryParams:    "?email=" + url.QueryEscape("jane.smith"),
			expectedStatus: http.StatusOK,
			expectError:    false,
			minResults:     1,
			expectedTotal:  1,
		...
		{
			name:           "filter by student ID",
			userRole:       authorization.ROLE_BOT.ToString(),
			semesterID:     testutils.TEST_SEMESTERS[0].ID.String(),
			queryParams:    "?studentId=" + fmt.Sprintf("%d", testutils.TEST_USERS[0].ID),
			expectedStatus: http.StatusOK,
			expectError:    false,
			minResults:     1,
			expectedTotal:  1,
		...
		{
			name:           "filter by name and faculty combined",
			userRole:       authorization.ROLE_BOT.ToString(),
			semesterID:     testutils.TEST_SEMESTERS[0].ID.String(),
			queryParams:    "?name=John&faculty=Math",
			expectedStatus: http.StatusOK,
			expectError:    false,
			minResults:     1,
			expectedTotal:  1,
		...
		},
		{
			...
			userRole:       authorization.ROLE_BOT.ToString(),
			semesterID:     testutils.TEST_SEMESTERS[0].ID.String(),
			queryParams:    "?faculty=Math&limit=1&offset=0",
			expectedStatus: http.StatusOK,
			expectError:    false,
			minResults:     1,
			expectedTotal:  1,
		...
		{
			name:           "filter by paid and not discounted",
			userRole:       authorization.ROLE_BOT.ToString(),
			semesterID:     testutils.TEST_SEMESTERS[0].ID.String(),
			queryParams:    "?paid=true&discounted=false",
			expectedStatus: http.StatusOK,
			expectError:    false,
			minResults:     2,
			expectedTotal:  2,

...
class APIRouteHandler extends RouteHandler {
  handler() {
    ...
    const participantsRoute = new ParticipantsRouteHandler("/participants", this.db);
    ...
    this.router.use(participantsRoute.path, requireAuthentication, participantsRoute.handler());

import { FunctionComponent, Component, Ref, ReactNode, MutableRefObject } from "react";
...
export type SelectSearchProps = {
  ...
  renderValue?: (valueProps: ValueProps, snapshot: Snapshot, className: string) => ReactNode;
